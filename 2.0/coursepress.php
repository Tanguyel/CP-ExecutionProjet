...
//Ajout de la reconaissance des log par le plugin WP Debug Logger
$GLOBALS[ 'wp_log_plugins' ][] = 'CoursepressMod';
...
class CoursePress {
	 ...
	 * @var string
	 */
	public static $version = '2.2.0 / 0.1.0 Open';
	 ...
	 * @var string
	 */
	public static $name = 'EP CoursePress'; // Translated by grunt.
