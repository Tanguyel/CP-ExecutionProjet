...
<div class="cp-box-content step-content step-2">
	...
	<div class="wide">
		<label for="courseDescription" ><?php _e( 'Full Description', 'cp' ); ?></label><br /> <?php /* Ajout EP : supression de class="required" sur le label*/ ?>
	...
	echo CoursePress_Helper_UI::browse_media_field(
		...
		'meta_pdf_description',
		array(
			'placeholder' => sprintf( __( 'Add URL or Browse ( %s )', 'cp' ), 'pdf'),
			'title' => __( 'Fiche Descriptive', 'cp' ),
			'value' => CoursePress_Data_Course::get_setting( $course_id, 'pdf_description' ),
			'type' => 'pdf',
			'description' => __( 'This is used to add the link to the descriptive card of the course', 'cp' ),
		)
	);
	?>
    
    <div class="wide">
		<label for="meta_course_objectives" ><?php _e( 'Objectives', 'cp' ); ?></label><br />
		<?php echo static::get_wp_editor( 'course_objectives', 'meta_course_objectives', $course_objectives); ?>
	</div>
    <div class="wide">
		<label for="meta_course_resources" ><?php _e( 'Educational Resources', 'cp' ); ?></label><br/>
		<?php echo static::get_wp_editor( 'courseResources', 'meta_course_resources', $course_resources, array( 'media_buttons' => false ) ); ?>
	</div>
    <div class="wide">
		<label for="meta_course_public" ><?php _e( 'Public', 'cp' ); ?></label><br />
		<?php echo static::get_wp_editor( 'coursePublic', 'meta_course_public', $course_public, array( 'media_buttons' => false ) ); ?>
	</div>
    <div class="wide">
		<label for="meta_course_prerequisites" ><?php _e( 'Prerequisites', 'cp' ); ?></label><br />
