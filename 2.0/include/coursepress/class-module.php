	...
	public static function submit( $input ) {
		...
		//Ajout EP CP
                            if ( defined( 'WP_DEBUG_LOG' ) ) {
                               // $GLOBALS['wp_log']['CoursepressMod'][] = 'Submit : Enregistrement de la reponse' . implode(' ',$response) . 'pour le module' . implode(' ',$module_id);
                            };
  	//Fin Ajout EP CP                       
							...
							//Ajout EP CP 
              	if ( defined( 'WP_DEBUG_LOG' ) ) {
              		//$GLOBALS['wp_log']['CoursepressMod'][] = 'Submit : appel de module response avec comme parametres : ' . $student_id . $course_id . $unit_id . $module_id . implode(' ; ', $response);
                };
							//Fin ajout EP CP 
								CoursePress_Data_Student::module_response( $student_id, $course_id, $unit_id, $module_id, $response );
							}
		...
		//Ajout EP CP
                if ( defined( 'WP_DEBUG_LOG' ) ) {
                    //$GLOBALS['wp_log']['CoursepressMod'][] = 'Valeur de html, url, type et reload dans le JSON transmis: ' . $html . ', ' . $next['url'] . ', ' . $type . ', ' . $reload;
                    //GLOBALS['wp_log']['CoursepressMod'][] = 'Valeur de $next[ID]: ' . $next['id'] . ', et $is_focus' . $is_focus;
                }
		//Fin Ajout EP CP 
		...
		//Ajout EP CP
                //if ( defined( 'WP_DEBUG_LOG' ) ) {
                //    GLOBALS['wp_log']['CoursepressMod'][] = 'Json transmis : ' . implode(' ; ', $json_data);
                //}
		//Fin Ajout EP CP
