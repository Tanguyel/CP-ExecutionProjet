			...
			foreach ( $courses as $course ) {
				...
				foreach ( $column_keys as $column_key ) {
					switch ( $column_key ) {
                        ...
                        case 'formule':
                            $group = get_user_option( 'enrolled_course_group_' . $course->ID, $item_id ); 
                            $course_id = $course->ID;
                            ...
                            if ( strpos( $group, CoursePress_Data_Course::get_setting( $course_id, 'base_formula_tag' ))!==false) {
                                ...
                                $group_class = 'paid';
                                $group_name = __( 'Payante', 'coursepress' );
                                ...
                                $group_class = 'free';
                                $group_name = __( 'Gratuite', 'coursepress' );
                            ...
                            $table_body .= sprintf(	'<td class="column-formule"><span class="formule %s">%s</span></td>', $group_class, $group_name );
                            break;
                        // Fin Ajout EP CP
