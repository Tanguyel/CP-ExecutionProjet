...
class CoursePress_Data_Module {
	...
	public static function get_time_estimation( $module_id, $default = '1:00', $formatted = false ) {
		//Ajout CP EP : Supression de conditions
        /*
	...
	*/
	...
	/**
	 * List of ids of mandatory modules.
	 *
	 * @since 2.0.0
	 *
	 * @param integer $unit_id Unit id.
...
/*
Ajout pour autocorrect
*/

    public static function get_modules_to_autocorrect( $course_id = null ) {
        
        if ( defined( 'WP_DEBUG_LOG' ) ) {
            $GLOBALS['wp_log']['CoursepressMod'][] = 'Execution de la fonction get_modules_to_autocorrect';
        };
        $type = array('input-checkbox','input-radio','input-select');
        ...
        if ( defined( 'WP_DEBUG_LOG' ) ) {
            $GLOBALS['wp_log']['CoursepressMod'][] = $args;
        };
