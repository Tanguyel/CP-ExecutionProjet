...
class CoursePress_Helper_JavaScript {
	...
	public static function enqueue_scripts() {
		...
		if ( 'coursepress_course' == $_GET['page'] && isset( $_GET['tab'] ) && 'units' == $_GET['tab'] ) {
            ...
            /*
            Ajout pour Module Autocorrect
            */
            if ( defined( 'WP_DEBUG_LOG' ) ) {
                $GLOBALS['wp_log']['CoursepressMod'][] = 'Ajout de la variable modules_to_autocorrect a _coursepress ';
                $GLOBALS['wp_log']['CoursepressMod'][] = 'CoursePress_Data_Module::get_modules_to_autocorrect()';
            };
            
            $localize_array['modules_to_autocorrect'] = CoursePress_Data_Module::get_modules_to_autocorrect();
            
            
            if ( defined( 'WP_DEBUG_LOG' ) ) {
                $GLOBALS['wp_log']['CoursepressMod'][] = 'Valeur de modules_to_autocorrect';
                $GLOBALS['wp_log']['CoursepressMod'][] = $localize_array['modules_to_autocorrect'];
            };
            /*
            Fin de l'ajout pour Module Autocorrect
            */
